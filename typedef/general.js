...
const messenger = {
  accounts: {
     ...
     * 
     * Required permissions [accountsRead]
     * @param {boolean} [includeFolders] Specifies whether the returned MailAccount objects should included their account’s folders.
     * @returns {Promise<MailAccount[]>}
     */
    list: (includeFolders = true) => {}
  },
  storage: {
    /**
     * @type {StorageArea}
