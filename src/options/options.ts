...
import * as messenger from 'webextension-polyfill'
...
// DOM Variables
const inputScoreBoundsLower: HTMLInputElement = <HTMLInputElement>document.getElementById('score-bounds-lower')
const inputScoreBoundsUpper: HTMLInputElement = <HTMLInputElement>document.getElementById('score-bounds-upper')
const inputScoreBoundsBetween: HTMLInputElement = <HTMLInputElement>document.getElementById('score-bounds-between')
const checkboxIconScorePositive: HTMLInputElement = <HTMLInputElement>(
  document.getElementById('hide-icon-score-positive')
)
const checkboxIconScoreNeutral: HTMLInputElement = <HTMLInputElement>document.getElementById('hide-icon-score-neutral')
const checkboxIconScoreNegative: HTMLInputElement = <HTMLInputElement>(
  document.getElementById('hide-icon-score-negative')
)
...
async function init() {
  ...
  // Set Values
  inputScoreBoundsLower.value = lowerBounds.toString()
  inputScoreBoundsUpper.value = upperBounds.toString()
...
async function saveScoreLower() {
  ...
  if (scoreBoundsLower !== '') {
    ...
    inputScoreBoundsLower.value = newLowerBounds.toString()
  }
}
...
async function saveScoreUpper() {
  ...
  if (scoreBoundsUpper !== '') {
    ...
    // This way the value is a number
    inputScoreBoundsUpper.value = newUpperBounds.toString()
  }
}
